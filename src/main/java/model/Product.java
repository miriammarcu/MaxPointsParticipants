...
public class Product {
	...
	public void read() throws IOException{
		...
		try{ 
			...
			this.quantity=-1;// here the user should not stay and think what is >=0, it should be clearer
			System.err.print("Quantity not >=0");
			//System.err.print("The Quantity must be a positive number);
		...
		try{ 
			...
			System.err.print("error Code not >0"); //the same as above,the message should be : The code must be a positive number
