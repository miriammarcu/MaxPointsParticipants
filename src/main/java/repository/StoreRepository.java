...
public class StoreRepository {
	...
	public void readFile(String fname) throws NumberFormatException, IOException{
		...
		while((rd=buf.readLine())!=null){
				line=rd.split(" ");
				if(rd.trim().isEmpty()) //here because it was an empty row in the input txt file, it throws java.lang.NumberFormatExceptio
					continue;  //if it finds a row which is null,then it continues
